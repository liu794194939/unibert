        ...
        with graph.as_default():
            with tf.Session() as sess:
                ...
                loss, per_example_loss, logits, probabilities = create_classification_model(bert_config=bert_config, is_training=False,
                    input_ids=input_ids, input_mask=input_mask, segment_ids=segment_ids, labels=None, num_labels=num_labels)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-bert_model_dir', type=str,default='/home/Sentence_Similarity/chinese_L-12_H-768_A-12',
                        help='chinese google bert model path')
    parser.add_argument('-model_dir', type=str, default='/home/Sentence_Similarity/bert/output',
                        help='directory of a pretrained BERT model')
    parser.add_argument('-model_pb_dir', type=str, default='/home/Sentence_Similarity/bert/output',
